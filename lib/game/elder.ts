...
export const POST_SPIRIT_SCOUT_DIALOGUE: ElderDialogue = {
  ...
  beats: [
    ...
    {
      speaker: "elder",
      text: "Харин тэр овоон дээр шилэн лонхтой рашаан үлдээнэ. Гурван балга л байна. Q дарж сонгоод нэг балгавал амьны үзүүлэлт бүрэн дүүрнэ. Могойг дарсны дараа Шидэт харваач, Шулмасын зарц, Талын харагч гэсэн үлдсэн гурав босно.",
    },
    {
      speaker: "elder",
