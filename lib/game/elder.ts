...
export const POST_SPIRIT_SCOUT_DIALOGUE: ElderDialogue = {
  ...
  beats: [
    ...
    {
      speaker: "boy",
      text: "Бар хул, Лалар, Чөтгөр болон бусад сахиулууд хүлээж байв. Чулуугүй учир могойг дарах боломжгүй байлаа. Гэвч аав, ээжийн минь мөр тэнд байна гэдгийг би мэдэрч байна.",
    },
    {
      speaker: "elder",
...
export const SPIRIT_GATE_DIALOGUE: ElderDialogue = {
  ...
  beats: [
    ...
    {
      speaker: "elder",
      text: "Би бөөгийн толиороо орон зайн заагийг нээнэ. Тэр ертөнцөд ороход бодит дэлхийн цаг хугацаа зогсох тул чиний хонь, ямаанд аюул тохиолдохгүй. Гэвч тэнд Аварга могой, Лалар, Бар хул, Чөтгөр, Харваач чөтгөр хүлээж байгааг санагтун! Чи явахад бэлэн үү?",
    },
  ],
};
