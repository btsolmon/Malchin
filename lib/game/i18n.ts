...
const EN: Record<StringKey, string> = {
  ...
  "hud.milk": "Milk",
  "hud.bag": "BAG",
  "hud.bagHint": "WASD / arrows — pick · Enter — assign to hotbar · Tab close",
  "hotbar.fists": "Fists",
  "hotbar.sword": "Sword",
  "hotbar.bow": "Bow",
  "hotbar.fence": "Fence",
