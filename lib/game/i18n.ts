...
const MN = {
  ...
  "controls.walk": "Алхах",
  "controls.attack": "Нударга сонгоод J-ээр цохих",
  "controls.bow": "Нум сонгоод J-ээр харвах",
  "controls.dodge": "Бултах — invuln цонх",
  "controls.parry": "Сөрөх (parry) — дайралт няцаах",
  "controls.weapon": "1 нударга · 2 нум · 3 хашаа",
  ...
  "controls.fence": "Хашаа сонгоод J-ээр барих",
...
const EN: Record<StringKey, string> = {
  ...
  "controls.walk": "Move",
  "controls.attack": "Select fists, then J to punch",
  "controls.bow": "Select bow, then J to shoot",
  "controls.dodge": "Dodge — invulnerability window",
  "controls.parry": "Parry — deflect an attack",
  "controls.weapon": "1 fists · 2 bow · 3 fence",
  ...
  "controls.fence": "Select fence, then J to build",
