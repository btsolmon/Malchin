...
export function dayPhaseHint(
  ...
  if (phase === "dawn") {
    return flockOut
      ? "Үүр — дулаацаад ажилдаа ор"
      : "Үүр — гал түл, E-ээр малаа бэлчээрт гарга";
  }
  if (phase === "day") {
    if (season === "summer") return "Өдөр — өвс/жимс · хоньны ноос түү";
    if (season === "autumn") return "Өдөр — түлээ нөөцөл, хашаа хүчитгэ";
    if (season === "spring") return "Өдөр — ноолуур түү · хурга/ишиг дулаан байлга";
    return "Өдөр — гэрт дулаацаж, тэжээгчээ бэлд";
  }
  if (phase === "evening") {
    return flockOut
      ? "Орой — малаа N-ээр тууж хашаанд оруул! E — оруулах"
      : "Орой — мал хашаандаа. Шөнө ойртож байна";
  }
  return flockOut
    ? "Шөнө — мал гадаа! Чоно/баавгайн аюултай"
    : "Шөнө — мал хашаандаа. Галд дулаац";
}
...
/** Тэжээгчийн дэргэд E — мал гаргах / оруулах */
